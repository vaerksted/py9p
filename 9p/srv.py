...
nochg2 = 0xffff
nochg4 = 0xffffffff
nochg8 = 0xffffffffffffffff
nochgS = ''

ServError = P9.ServError


class Error(P9.Error):
    pass
...
class AuthFs(object):
    ...
    """
    type = ord('a')
    HaveProtos, HaveSinfo, HaveSauth, NeedProto, NeedCchal, NeedTicket, Success = list(range(7))
    cancreate = 0
...
class LocalFs(object):
    ...
    def stat(self, f):
        ...
        u = uidname(s.st_uid)
        return (0, 0, s.st_dev, None, s.st_mode & 0o777,
    ...
    def wstat(self, f, st):
        ...
        if name != nochgS:
            ...
            f.localpath = new
        if mode != nochg4:
            _os(os.chmod, f.localpath, mode & 0o777)
    ...
    def create(self, f, perm, mode):
        ...
        if perm & P9.DIR:
            ...
            _os(os.chmod, f.localpath, perm & 0o777)
            f.isdir = 0
